...
/*                                                                            */
/*                                                        ::::::::            */
/*   filler_parsingcheck.c                              :+:    :+:            */
/*                                                     +:+                    */
/*   By: tide-jon <tide-jon@student.codam.nl>         +#+                     */
/*                                                   +#+                      */
/*   Created: 2019/07/03 16:41:33 by tide-jon       #+#    #+#                */
/*   Updated: 2019/07/04 16:26:32 by tide-jon      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
write(1, ft_itoa(data->legal_moves->y), ft_digcount(data->legal_moves->y));
write(1, " ", 1);
write(1, ft_itoa(data->legal_moves->x), ft_digcount(data->legal_moves->x));
write(1, "\n", 1);
